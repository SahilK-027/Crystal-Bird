...
void main() {
  ...
  if(particle.a >= 1.0) {
    ...
    vec3 flowField = vec3(simplexNoise4d(vec4(particle.xyz * uFrequency + 0.0, time)), simplexNoise4d(vec4(particle.xyz * uFrequency + 1.0, time)), simplexNoise4d(vec4(particle.xyz * uFrequency + 2.0, time)));
